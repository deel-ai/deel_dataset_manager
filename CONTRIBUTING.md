...
- Clone the repo `git clone https://github.com/deel-ai/deel_dataset_manager.git`.
- Go to your freshly downloaded repo `cd deel_dataset_manager`
...
your pull request should be accepted quickly (see [Governance policy](https://github.com/deel-ai/deel_dataset_manager/blob/master/GOVERNANCE.md)).
