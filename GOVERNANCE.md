...
`deel-datasets manager` is developped as part of the Artificial and Natural Intelligence Toulouse Institute (DEEL/ANITI) program.
...
The governance committee is initially composed of DEEL members who contributed to the first version of `deel-datasets manager` and are the only contributors to the master branch.
